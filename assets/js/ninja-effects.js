...
class NinjaEffects {
    ...
    init() {
        // this.createParticles(); // Disabled for performance
        this.initScrollAnimations();
        // this.initCursorEffects(); // Disabled for performance
        this.initPageTransitions();
        this.initCounters(); // Re-enabled for stats functionality
        this.initSkillBars(); // Re-enabled for progress bars
        
        console.log('🥷 NinjaTech Effects Activated (Optimized)!');
    }
